...
class Shareroomrent extends StatefulWidget {
  @override
  _ShareroomrentState createState() => _ShareroomrentState();
}

class _ShareroomrentState extends State<Shareroomrent> {
  ...
  String selectedPropertyType = 'Shared Room';
  ...
  String selectedTenants = '1';
  bool isOwnerOccupied = false;
  bool isPlusOneAllowed = false;
  String? selectedPreference;
  String? selectedDate;

  List<String> propertyTypeList = [

    'Shared Room', 'Apartment', 'House',
  ];
  ...
  List<String> Selectnumberoftenants = [
    '1', '2', '3', '4', '5'
  ];
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      await _firestoreService.Shareroomrent(
        ...
        ownerOccupied: isOwnerOccupied,
        selectedPreference: selectedPreference ?? 'Not specified',
            ...
            child: ListView(
              children: [
                ...
                DropdownButtonFormField(
                  ...
                  isExpanded: true,
                  hint: Text('Select No of Tenants'),
                  items: Selectnumberoftenants.map((option) {
                    return DropdownMenuItem(
                      value: option,
                      child: Text(option, style: TextStyle(fontSize: 14)),
                    );
                ...
                Row(
                  children: [
                    Checkbox(
                      value: isOwnerOccupied,
                      onChanged: (value) {
                        setState(() {
                          isOwnerOccupied = value ?? false;
                        });
                      },
                    ),
                    Text('Owner occupied', style: TextStyle(fontSize: 14, color: Theme.of(context).textTheme.bodyMedium!.color)),
                  ],
                ),
                SizedBox(height: 20),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            selectedPreference = 'Males only';
                          });
                        },
                        style: ElevatedButton.styleFrom(
                          elevation: 0,
                          backgroundColor: selectedPreference == 'Males only' ? Colors.red.shade300 : Colors.white,
                        ...
                        child: Text(
                          'Males only',
                          style: TextStyle(
                            color: selectedPreference == 'Males only' ? Colors.white : Colors.black,
                            fontSize: 14,
                          ),
                        ),
                      ),
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            selectedPreference = 'Females only';
                          });
                        },
                        style: ElevatedButton.styleFrom(
                          elevation: 0,
                          backgroundColor: selectedPreference == 'Females only' ? Colors.red.shade300 : Colors.white,
                          side: BorderSide(color: Colors.grey.shade400),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8),
                          ),
                        ...
                        child: Text(
                          'Females only',
                          style: TextStyle(
                            color: selectedPreference == 'Females only' ? Colors.white : Colors.black,
                            fontSize: 14,
                          ),
                        ),
                      ),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          setState(() {
                            selectedPreference = 'Either';
                          });
                        },
                        style: ElevatedButton.styleFrom(
                          elevation: 0,
                          backgroundColor: selectedPreference == 'Either' ? Colors.red.shade300 : Colors.white,
                          side: BorderSide(color: Colors.grey.shade400),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8),
                          ),
                        ...
                        child: Text(
                          'Either',
                          style: TextStyle(
                            color: selectedPreference == 'Either' ? Colors.white : Colors.black,
                            fontSize: 14,
                          ),
                        ),
                      ),
                ...
                // +1 person allowed checkbox
                Row(
                  children: [
                    Checkbox(
                      value: isPlusOneAllowed,
                      onChanged: (value) {
                        setState(() {
                          isPlusOneAllowed = value ?? false;
                        });
                      },
                    ),
                    Text('+1 person is allowed', style: TextStyle(fontSize: 14, color: Theme.of(context).textTheme.bodyMedium!.color)),
                  ],
                ),
